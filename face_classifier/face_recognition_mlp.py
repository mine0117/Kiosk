...
def train(train_dir, verbose=False):
    ...
    model_path = "s03p31b107/face_classifier/"
...
def predictionss(X_img_path: str, detection_model: str, jitters: int, encoding_models: str,
    ...
    with open("s03p31b107/face_classifier/model.pkl", 'rb') as f:
...
if __name__ == "__main__":
    ...
    classifier = train("s03p31b107/face_classifier/train")
    ...
    CONFIG_FILE = "s03p31b107/face_classifier/config.json"
    ...
    full_path = "s03p31b107/face_classifier/test/"
