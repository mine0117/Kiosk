...
lib = CDLL("/home/team7/s03p31b107/darknet/libdarknet.so", RTLD_GLOBAL)
        ...
        for i in range(meta.classes):
            try:
                if dets[j].prob[i] > 0:
                    ...
                    #     print(meta.names[i], b.x)
                    if meta.names[i] == b'person' and b.x < 220:
...
if __name__ == "__main__":
    ...
    net = load_net(b"/home/team7/s03p31b107/darknet/cfg/yolov3-tiny.cfg", b"/home/team7/s03p31b107/darknet/yolov3-tiny.weights", 0) 
    meta = load_meta(b"/home/team7/s03p31b107/darknet/cfg/coco.data")
